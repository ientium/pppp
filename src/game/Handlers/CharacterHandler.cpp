...
bool LoginQueryHolder::Initialize()
{
	...
	//VIPInfo 信息查询
	res &= SetPQuery(PLAYER_LOGIN_QUERY_LOADVIPINFO, "SELECT vipcoin, generalcoin, activateTaxiTime, totaltime,guild_reputation,guildtime FROM character_vip WHERE guid = '%u'", m_guid.GetCounter());
