...
enum
{
  ...
  //SAY_KILL3                   = -1000154,
    ...
    SPELL_TWISTEDREFLECTION     = 21063
                                  ...
                                  // - Il passe en evade lorsqu'on s'eloigne trop. En fait il ne devrait jamais evade. Du coup impossible de verif' si ses shadowbolt ont bien 100yards de port閑.
                                  // - Il repop instantanement apres avoir 閠?loot? (Perso j'suis pas contre, il a des jambieres sympa :lol: )
